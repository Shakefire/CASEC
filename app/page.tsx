              ...
              <div className="max-w-7xl mx-auto px-6 w-full">
                <div className="max-w-2xl hero-content-1">
                  ...
                  <p className="mt-6 max-w-xl text-sm leading-7 text-emerald-100">
                    Welcome to the Career Services Centre OnlineUniversity, your
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              ...
              <div className="relative h-96 rounded-xl overflow-hidden shadow-xl">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center p-6">
                  ...
                  <p className="text-sm leading-6">Career Services Centre OnlineUniversity</p>
                </div>
              </div>
              ...
              <div>
                ...
                <h2 className="text-3xl font-bold text-slate-900 mb-6">Welcome to Career Services Centre OnlineUniversity</h2>
