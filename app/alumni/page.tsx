...
const successStories = [
  {
    ...
    category: "Tech",
    excerpt: "My journey from University, to becoming a software engineer at Google involved consistent learning, networking, and taking calculated risks.",
        ...
        <div className="max-w-7xl mx-auto px-4 relative">
          <div className="text-center">
            ...
            <p className="text-xl text-emerald-100 max-w-2xl mx-auto leading-relaxed animate-fade-in-up animation-delay-400">
              Discover success stories, find mentors, and build your professional network with University, alumni.
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Sarah's journey from University, to becoming a software engineer at Google involved
