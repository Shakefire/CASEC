...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  shortlisted: { label: "Shortlisted", className: "bg-sky-50 text-sky-700 border border-sky-200" },
  cancelled: { label: "Cancelled", className: "bg-red-50 text-red-700 border border-red-200" },
  inactive: { label: "Suspended", className: "bg-slate-100 text-slate-500 border border-slate-200" },
  job: { label: "Job", className: "bg-sky-50 text-sky-700 border border-sky-200" },
  event: { label: "Event", className: "bg-purple-50 text-purple-700 border border-purple-200" },
  scholarship: { label: "Scholarship", className: "bg-violet-50 text-violet-700 border border-violet-200" },
