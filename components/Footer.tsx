    ...
    <footer className="bg-slate-900 text-white py-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid gap-8 md:grid-cols-4 mb-8">
          ...
          <div>
            ...
            <p className="text-xs leading-6 text-stone-400">
              Career Services Centre, Online University – empowering students to discover and achieve their professional aspirations.
            </p>
          </div>
        ...
        <div className="border-t border-stone-800 pt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-xs text-stone-500">
          <p>© 2026 Career Services Centre, Online University. All Rights Reserved.</p>
